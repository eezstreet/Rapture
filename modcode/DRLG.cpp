...
bool Do_DrunkenStaggerSaturationLink(MazeFramework* ptFramework, Map& rtMap, RoomGrid& rtRoomGrid) {
	...
	bool* bConnects = (bool*)trap->Zone_Alloc(connectionSize, "roomgrid");
	memset(bConnects, false, connectionSize);
	...
	bool* bRanLastStage = (bool*)trap->Zone_Alloc(connectionSize, "roomgrid");
	memset(bRanLastStage, false, connectionSize);
